                ...
                ?>
                    ...
                    <br><br>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-4"><b>Nome do objeto: </b><input type="text" id="nome-objeto" name="nome-objeto" class="form-control" placeholder="Digite o nome do objeto" value="<?php echo $obra->nome_objeto ?>"></div>
                    ...
                    <br><br>
                      ...
                      <label> ANÁLISE</label>
                      <div class="row">
                        <div class="col-sm-12"><b>Descrição do objeto: </b><textarea type="text" id="descricao-objeto" name="descricao-objeto" class="form-control" rows="6" cols="100"><?php echo $obra->descricao_objeto ?></textarea></div>
                        <div class="col-sm-12"><b>Características técnicas: </b><textarea type="text" id="carac-tecnicas" name="carac-tecnicas" class="form-control" placeholder="Insira as características técnicas" maxlength="1000" rows="3" cols="100"><?php echo $obra->carac_tecnica ?></textarea></div>
                        <div class="col-sm-12"><b>Características inconográficas: </b><textarea type="text" id="carac-inconografica" name="carac-inconografica" class="form-control" placeholder="Insira as características inconográficas" maxlength="1000" rows="3" cols="100"><?php echo $obra->carac_inconografica ?></textarea></div>
                        <div class="col-sm-12"><b>Características estilisticas: </b><textarea type="text" id="carac-estilisticas" name="carac-estilisticas" class="form-control" placeholder="Insira as características estilísticas" maxlength="1000" rows="3" cols="100"><?php echo $obra->carac_estilistica ?></textarea></div>
                        <div class="col-sm-12"><b>Dados históricos: </b><textarea type="text" id="dados-historicos" name="dados-historicos" class="form-control" placeholder="Insira os dados históricos" maxlength="1000" rows="3" cols="100"><?php echo $obra->dados_historicos ?></textarea></div>
                      </div>
