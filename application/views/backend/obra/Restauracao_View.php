    ...
    <div class="row">
        ...
        <div class="col-sm-offset-10">
            ...
            <?php echo form_open('Obra_Controller/cadastrar_restauracao/'.$id_obra); ?>
                ...
                <button style="width: 230px" class="btn btn-default" type="submit"> Cadastrar restauração </button>
            <?php echo form_close();?>
            <!-- FIM -->
        </div>
    </div>
        ...
        <div class="col-sm-offset-2">
            <div class="card" style="width: 75rem">
                <div class="card-header">
                    <h4> Restauração de número <?php echo $restauracao->id_restauracao?> </h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <p class="card-text">
                ...
                <div class="card-footer text-muted">
                    <div class="col-sm-6">
                            ...
                            <?php echo form_open('Obra_Controller/atualizar_restauracao/'.$id_obra.'/'.$restauracao->id_restauracao); ?>
                                ...
                                <button style="width: 200px" class="btn btn-default" type="submit" name="txt-restauracao" value=""> Atualizar </button>
                            <?php echo form_close();?>
                            <!-- FIM -->
                    </div>
                    <div class="col-sm-6">
