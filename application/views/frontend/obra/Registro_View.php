...
<div class="container">
  ...
  <br><br>
    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        <b>Data da aquisição: </b><input readonly="true" placeholder="<?php echo date('d/m/Y',  strtotime($obra->data_aquisicao)) ?>">
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12"><b>Técnico Responsável pelo preenchimento técnico: </b><input readonly="true" placeholder="<?php echo $obra->resp_preenc_tec ?>"></div>
        ...
        <div class="col-sm-offset-6">
          <b> Data da digitação: </b><input readonly="true" placeholder="<?php echo date('d/m/Y',  strtotime($obra->data_digitacao)) ?>">
        </div>
        
        <div class="col-sm-6"><b>Responsável pela revisão: </b> <input readonly="true" placeholder="<?php echo $obra->resp_revisao ?>"></div>
        <div class="col-sm-offset-6">
          <b>Data da revisão:  </b><input readonly="true" placeholder="<?php echo date('d/m/Y',  strtotime($obra->data_revisao)) ?>">
        </div>
        
        <div class="col-sm-6"><b>Responsável pela alteração: </b><input readonly="true" placeholder="<?php echo $obra->resp_alteracao ?>"></div>
        <div class="col-sm-offset-6">
          <b>Data da alteração: </b><input readonly="true" placeholder="<?php echo date('d/m/Y',  strtotime($obra->data_alteracao)) ?>">
        </div>
