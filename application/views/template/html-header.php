...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url('assets/js/fancybox/jquery.fancybox.css') ?>" type="text/css"
			media="screen" />
		...
		<link href="<?php echo base_url('assets/css/subscribed_style.css') ?>" rel="stylesheet" />
