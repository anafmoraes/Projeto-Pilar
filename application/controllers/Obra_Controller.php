...
class Obra_Controller extends CI_Controller {
    ...
    public function salvar_obra() {
        ...
        $this->form_validation->set_rules('localizacao','Localização da obra','required | max_length[500]');
        ...
        $this->form_validation->set_rules('fichas-relacionadas','Fichas relacionadas a obra', 'max_length[45]');
        ...
        $this->form_validation->set_rules('epoca','Época da obra','required | max_length[250]');
        $this->form_validation->set_rules('autoria','Autoria da obra','required | max_length[250]');
        $this->form_validation->set_rules('origem','Origem da obra','required | max_length[500]');
        $this->form_validation->set_rules('procedencia','Procedência','required | max_length[250]');
        $this->form_validation->set_rules('conservacao','Conservação','required | max_length[250]');
        $this->form_validation->set_rules('altura','Altura da obra','required | max_length[50]');
        $this->form_validation->set_rules('largura','Largura da obra','required | max_length[50]');
        $this->form_validation->set_rules('comprimento','Comprimento da obra','required | max_length[50]');
        $this->form_validation->set_rules('profundidade','Profundidade da obra','required | max_length[50]');
        $this->form_validation->set_rules('diametro','Diâmetro da obra','required | max_length[50]');
        $this->form_validation->set_rules('peso','Peso da obra','required | max_length[50]');
        $this->form_validation->set_rules('circunferencia','Circunferencia da obra','required | max_length[50]');
        ...
        $this->form_validation->set_rules('dados-historicos','Dados historicos','required | max_length[50]');
